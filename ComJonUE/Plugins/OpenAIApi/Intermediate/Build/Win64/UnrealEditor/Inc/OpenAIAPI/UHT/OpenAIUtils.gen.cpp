...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UOpenAIUtils_setOpenAIApiKey_Statics::NewProp_apiKey = { "apiKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAIUtils_eventsetOpenAIApiKey_Parms, apiKey), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UOpenAIUtils_setUseOpenAIApiKeyFromEnvironmentVars_Statics::NewProp_bUseEnvVariable = { "bUseEnvVariable", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(OpenAIUtils_eventsetUseOpenAIApiKeyFromEnvironmentVars_Parms), &Z_Construct_UFunction_UOpenAIUtils_setUseOpenAIApiKeyFromEnvironmentVars_Statics::NewProp_bUseEnvVariable_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOpenAIUtils_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOpenAIUtils_setOpenAIApiKey, "setOpenAIApiKey" }, // 3604090399
		{ &Z_Construct_UFunction_UOpenAIUtils_setUseOpenAIApiKeyFromEnvironmentVars, "setUseOpenAIApiKeyFromEnvironmentVars" }, // 3498123519
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAIUtils_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAIUtils_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenAIUtils, UOpenAIUtils::StaticClass, TEXT("UOpenAIUtils"), &Z_Registration_Info_UClass_UOpenAIUtils, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenAIUtils), 1632381572U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAIUtils_h_2989199121(TEXT("/Script/OpenAIAPI"),
		Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAIUtils_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAIUtils_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
