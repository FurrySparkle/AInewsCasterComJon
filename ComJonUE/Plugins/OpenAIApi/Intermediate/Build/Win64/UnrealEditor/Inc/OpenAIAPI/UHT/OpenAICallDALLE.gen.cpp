...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_generatedImageUrls_MetaData[];
#endif
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_generatedImageUrls_Inner = { "generatedImageUrls", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_generatedImageUrls_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_generatedImageUrls = { "generatedImageUrls", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_OpenAIAPI_eventOnDalleResponseRecievedPin_Parms, generatedImageUrls), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_generatedImageUrls_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_generatedImageUrls_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_errorMessage_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_errorMessage = { "errorMessage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_OpenAIAPI_eventOnDalleResponseRecievedPin_Parms, errorMessage), METADATA_PARAMS(Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_errorMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_errorMessage_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_Success = { "Success", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(_Script_OpenAIAPI_eventOnDalleResponseRecievedPin_Parms), &Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_Success_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOpenAICallDALLE_OpenAICallDALLE_Statics::NewProp_imageSize = { "imageSize", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAICallDALLE_eventOpenAICallDALLE_Parms, imageSize), Z_Construct_UEnum_OpenAIAPI_EOAImageSize, METADATA_PARAMS(nullptr, 0) }; // 1842965495
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UOpenAICallDALLE_OpenAICallDALLE_Statics::NewProp_prompt = { "prompt", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAICallDALLE_eventOpenAICallDALLE_Parms, prompt), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UOpenAICallDALLE_OpenAICallDALLE_Statics::NewProp_numImages = { "numImages", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAICallDALLE_eventOpenAICallDALLE_Parms, numImages), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOpenAICallDALLE_OpenAICallDALLE_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAICallDALLE_eventOpenAICallDALLE_Parms, ReturnValue), Z_Construct_UClass_UOpenAICallDALLE_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOpenAICallDALLE_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOpenAICallDALLE_OpenAICallDALLE, "OpenAICallDALLE" }, // 2553108648
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOpenAICallDALLE_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOpenAICallDALLE_Statics::NewProp_Finished_MetaData[] = {
		{ "Category", "OpenAI" },
		{ "ModuleRelativePath", "Public/OpenAICallDALLE.h" },
	};
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOpenAICallDALLE_Statics::NewProp_Finished = { "Finished", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOpenAICallDALLE, Finished), Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UOpenAICallDALLE_Statics::NewProp_Finished_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOpenAICallDALLE_Statics::NewProp_Finished_MetaData)) }; // 2267326731
	...
	struct Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAICallDALLE_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAICallDALLE_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenAICallDALLE, UOpenAICallDALLE::StaticClass, TEXT("UOpenAICallDALLE"), &Z_Registration_Info_UClass_UOpenAICallDALLE, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenAICallDALLE), 1561355302U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAICallDALLE_h_4077763462(TEXT("/Script/OpenAIAPI"),
		Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAICallDALLE_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OpenAI_511_Plugins_OpenAIApi_Source_OpenAIAPI_Public_OpenAICallDALLE_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
