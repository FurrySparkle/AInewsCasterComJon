...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc SlateElementPixelShader.d3dasm /Fo SlateElementPixelShader.dxil SlateElementPixelShader.usf
:END
PAUSE
